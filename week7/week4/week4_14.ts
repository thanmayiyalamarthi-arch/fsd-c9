//NameSapcesnamespace GovernmentID{     const AadharLength=12;     export function validateAadhar(id:string):boolean{         const isNumeric=/^\+$/.test(id);        return isNumeric &&id.length===AadharLength;}export function validatePAN(pan:string):boolean{    const panRegex=/^[A-Z]{5}[0-9]{4}[A-Z]{1}$/;    return panRegex.test(pan.toUpperCase());}export namespace Tax{    export function calculateGST(amount:number):numb
//NameSapces
